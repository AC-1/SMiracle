...
<html>
	...
	<script type="text/javascript">
		...
		$(function(){	
			...
			setOptionSelected("weekday",'<c:out value="${worship.weekday}" />');
			setOptionSelected("edu",'<c:out value="${worship.edu}" />');
                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<h2 class="campaign_ttl">修改-崇拜資料-設定</h2>
						
						<form method="post" action="children/sign/updateworship" onsubmit="return checkThing();">
