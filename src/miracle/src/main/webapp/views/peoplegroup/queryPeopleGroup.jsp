...
<html>
	...
	<script type="text/javascript" src="<c:url value="/resources/js/jquery/jquery.controlPagerJpa.js"/>"></script>
		...
		<script type="text/javascript">
			...
			function add(){
				location.href='<c:url value="/children/sign/addpeoplegroup"/>';
			}
			...
			function PageClick(pageclickednumber) {
				...
				window.location.href='<c:url value="/children/sign/querypeoplegroup?pageNumber='+pageclickednumber+'"/>'; 
			}
                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
	                   	...
	                   	<div id="dialog"></div>
							<h2 class="campaign_ttl">小組資料-設定</h2>
							<br />
							<p align="center">
							...
							<br />
								...
								<div class="shopDataForm" style="width: 1200px">
									<table>
										<tr>
											...
											<th class="orangeBg">小組名稱</th>
											<th class="orangeBg">小組Leader</th>
											<th class="orangeBg">Status</th>
											<th class="orangeBg">Table</th>
											<th class="orangeBg">Owner</th>
										</tr>
										
 										<c:forEach items="${peopleGroupList}" var="peopleGroup" varStatus="s"> 
											<tr id="row_itemId_1401171148326500">
												<td class="embg"><a href="javascript:void(0)" onclick="editData('${peopleGroup.id}');" class="button">編輯</a></td>
												<td class="embg"><a href="javascript:void(0)" onclick="deleteData('${peopleGroup.id}');" class="button">刪除</a></td>
												<td class="embg">${peopleGroup.name}</td>
												<td class="embg">${peopleGroup.leader}</td>
												<td class="embg">${peopleGroup.status}</td>
												<td class="embg">${peopleGroup.groupTable}</td>
												<td class="embg">${peopleGroup.owner}</td>
											</tr>
										</c:forEach>
								...
								<form name="dataForm" id="dataForm" action="children/sign/editpeoplegroup" method="post">
									<input type="hidden" id="id" name="id">
									<input type="hidden" id="pageNumber1" name="pageNumber1">
								</form>
								
								<form name="delDataForm" id="delDataForm" action="children/sign/deletepeoplegroup" method="post">
									<input type="hidden" id="id" name="id">
