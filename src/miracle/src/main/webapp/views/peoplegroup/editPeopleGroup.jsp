                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<h2 class="campaign_ttl">修改-小組資料-設定</h2>
						
						<form method="post" action="children/sign/updatepeoplegroup" onsubmit="return checkThing();">
							...
							<div align="center">
								...
								<input type="hidden" name="id" value="${peopleGroup.id}"/>
							</div>
						</form>
