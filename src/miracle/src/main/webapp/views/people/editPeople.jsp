...
<html>
	...
	<script type="text/javascript">
		...
		$(function(){	
			...
			setOptionSelected("role",'<c:out value="${people.role}" />');
			setOptionSelected("status",'<c:out value="${people.status}" />');
			setOptionSelected("comm",'<c:out value="${people.comm}" />');
			setOptionSelected("groupId",'<c:out value="${people.groupId}" />');
			setOptionSelected("edu",'<c:out value="${people.edu}" />');
			setOptionSelected("grade",'<c:out value="${people.grade}" />');
			setOptionSelected("worship",'<c:out value="${people.worship}" />');
                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<h2 class="campaign_ttl">修改-個人資料-設定</h2>
						
						<form method="post" action="children/sign/updatepeople" onsubmit="return checkThing();">
