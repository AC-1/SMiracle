	...
	<script type="text/javascript">
	    ...
	    function checkThing() {
 		...
 		function goBack(){
	    	...
	    	window.location.href='<c:url value="/children/sign/querycomm?pageNumber='+pageNumber+'"/>'; 
	    }
                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<h2 class="campaign_ttl">新增-牧區資料-設定</h2>
						
						<form method="post" action="children/sign/createcomm" onsubmit="return checkThing();">
							<div class="shopDataForm">
								<table id="tb" border="0" cellspacing="0" cellpadding="0" width="100%">
									...
									<tr>
										<td><label>*</label>&nbsp;牧區名稱</td>
										<td class="fillembg">
										<input type="text" id="name" name="name" style="width: 250px;" size="10" value="${comm.name}">
										</td>
									</tr>
