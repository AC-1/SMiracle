...
<html>
	...
	<script type="text/javascript">
		...
		$(function(){	
			...
			setOptionSelected("role",'<c:out value="${usersVO.roleId}" />');
                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<form name="dataForm" id="dataForm" action="users/sign/updatusers" method="post">
							<div class="shopDataForm">
								<table id="tb" border="0" cellspacing="0" cellpadding="0" width="100%">
	                                ...
	                                <tr>
	                                    ...
	                                    <td class="fillembg"><input type="password"  maxlength="30" name="password" id="password" value="${usersVO.password}"/></td>
	                                </tr>  
	                                <tr>
	                                    <td class="embg"><label>*</label>&nbsp;確認密碼</td>
	                                    <td class="fillembg"><input type="password" maxlength="30" name="confirmPassword" id="confirmPassword" value="${usersVO.password}"/></td>
	                                </tr>
				
									<tr>
										<td ><label>*</label>&nbsp;登入員姓名</td>
										<td class="fillembg"><input type="text" maxlength="30" name="name" id="name" value="${usersVO.name}" style="width: 130px"  />
										</td>
									</tr>
								...
								<input type="hidden" id="username" name="username" value="${usersVO.username}"/>
								<input type="hidden" id="id" name="id" value="${usersVO.id}"/>
								<input type="hidden" id="userRoldId" name="userRoldId" value="${usersVO.userRoldId}"/>
							</div>
							<br />
							<div align="center">
