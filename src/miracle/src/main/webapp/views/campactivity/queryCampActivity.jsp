...
<html>
	...
	<script type="text/javascript" src="<c:url value="/resources/js/jquery/jquery.controlPagerJpa.js"/>"></script>
		...
		<script type="text/javascript">
			...
			function add(){
				location.href='<c:url value="/college/sign/addcampactivity"/>';
			}
			...
			function PageClick(pageclickednumber) {
				...
				window.location.href='<c:url value="/college/sign/querycampactivity?pageNumber='+pageclickednumber+'"/>'; 
			}
                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
	                   	...
	                   	<div id="dialog"></div>
							<h2 class="campaign_ttl">營會資料-設定</h2>
							<br />
							<p align="center">
							...
							<br />
										...
										<tr>
 										...
 										<c:forEach items="${campActivityList}" var="campActivity" varStatus="s"> 
											<tr id="row_itemId_1401171148326500">
												<td class="embg"><a href="javascript:void(0)" onclick="editData('${campActivity.activityId}');" class="button">編輯</a></td>
												<td class="embg"><a href="javascript:void(0)" onclick="deleteData('${campActivity.activityId}');" class="button">刪除</a></td>
												<td class="embg">${campActivity.activityId}</td>
												<td class="embg">${campActivity.activityName}</td>
											</tr>
										</c:forEach>
								...
								<form name="dataForm" id="dataForm" action="college/sign/editcampactivity" method="post">
									<input type="hidden" id="id" name="id">
									<input type="hidden" id="pageNumber1" name="pageNumber1">
								</form>
								
								<form name="delDataForm" id="delDataForm" action="college/sign/deletecampactivity" method="post">
