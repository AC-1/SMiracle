                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<h2 class="campaign_ttl">新增-營會資料設定</h2>
						
						<form method="post" action="college/sign/createcampactivity" onsubmit="return checkThing();">
							<div class="shopDataForm">
								<table id="tb" border="0" cellspacing="0" cellpadding="0" width="100%">
									...
									<tr>
										...
										<td class="fillembg">
										<input type="text" id="activityName" name="activityName" style="width: 250px;" size="10" value="${activityName}">
										</td>
									</tr>
